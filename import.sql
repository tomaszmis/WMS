...
CREATE TABLE `warehouse_content` (
     ...
     CONSTRAINT wc_id_pk PRIMARY KEY(wc_id)
) ENGINE=InnoDB AUTO_INCREMENT=1;
...
ALTER TABLE delivery_products
    ADD CONSTRAINT dp_warehouse_fk
    FOREIGN KEY (dp_warehouse_id)
    REFERENCES warehouse(warehouse_id) ;
...
LOCK TABLES `warehouse_content` WRITE;
    INSERT INTO `warehouse_content` VALUES(1,1, 1262, 20, 165);
    INSERT INTO `warehouse_content` VALUES(2,1, 5613, 1, 1);
    INSERT INTO `warehouse_content` VALUES(3,1, 1523, 120, 0);
    INSERT INTO `warehouse_content` VALUES(4,1, 5612, 60, 100);
    INSERT INTO `warehouse_content` VALUES(5,1, 5231, 220, 0);
UNLOCK TABLES;

LOCK TABLES `delivery_products` WRITE;
    INSERT INTO `delivery_products` VALUES(1,1,215, 5612, 330);
    INSERT INTO `delivery_products` VALUES(2,1,124, 1262, 240);
UNLOCK TABLES;
